...
\begin{itemize}
\item \index{Web Interface}The system's GUI will run with Internet Explorer, Firefox, Chrome, Safari, and Opera.
...
\item The system will run on Microsoft-based servers and databases at \index{403 Security}403 Security.
\end{itemize}
